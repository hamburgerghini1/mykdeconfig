...
# Autogenerated from man page /usr/lib/jvm/default/man/man1/qemu-system-mips64el.1.gz
...
complete -c qemu-system-mips64el -o soundhw -o soundhw -d 'Enable audio and selected sound hardware'
...
complete -c qemu-system-mips64el -o curses -d 'Normally, if QEMU is compiled with graphical window support, it displays outp…'
complete -c qemu-system-mips64el -o alt-grab -d 'Use Ctrl-Alt-Shift to grab mouse (instead of Ctrl-Alt)'
complete -c qemu-system-mips64el -o ctrl-grab -d 'Use Right-Ctrl to grab mouse (instead of Ctrl-Alt)'
complete -c qemu-system-mips64el -o sdl -d 'Enable SDL'
...
complete -c qemu-system-mips64el -o watchdog -d 'Create a virtual hardware watchdog device'
...
complete -c qemu-system-mips64el -o enable-fips -d 'Enable FIPS 140-2 compliance mode'
