# qemu-system-rx
# Autogenerated from man page /usr/lib/jvm/default/man/man1/qemu-system-rx.1.gz
...
complete -c qemu-system-rx -o soundhw -o soundhw -d 'Enable audio and selected sound hardware'
...
complete -c qemu-system-rx -o curses -d 'Normally, if QEMU is compiled with graphical window support, it displays outp…'
complete -c qemu-system-rx -o alt-grab -d 'Use Ctrl-Alt-Shift to grab mouse (instead of Ctrl-Alt)'
complete -c qemu-system-rx -o ctrl-grab -d 'Use Right-Ctrl to grab mouse (instead of Ctrl-Alt)'
complete -c qemu-system-rx -o sdl -d 'Enable SDL'
...
complete -c qemu-system-rx -o watchdog -d 'Create a virtual hardware watchdog device'
...
complete -c qemu-system-rx -o enable-fips -d 'Enable FIPS 140-2 compliance mode'
