# qemu-system-or1k
# Autogenerated from man page /usr/lib/jvm/default/man/man1/qemu-system-or1k.1.gz
...
complete -c qemu-system-or1k -o soundhw -o soundhw -d 'Enable audio and selected sound hardware'
...
complete -c qemu-system-or1k -o curses -d 'Normally, if QEMU is compiled with graphical window support, it displays outp…'
complete -c qemu-system-or1k -o alt-grab -d 'Use Ctrl-Alt-Shift to grab mouse (instead of Ctrl-Alt)'
complete -c qemu-system-or1k -o ctrl-grab -d 'Use Right-Ctrl to grab mouse (instead of Ctrl-Alt)'
complete -c qemu-system-or1k -o sdl -d 'Enable SDL'
...
complete -c qemu-system-or1k -o watchdog -d 'Create a virtual hardware watchdog device'
...
complete -c qemu-system-or1k -o enable-fips -d 'Enable FIPS 140-2 compliance mode'
